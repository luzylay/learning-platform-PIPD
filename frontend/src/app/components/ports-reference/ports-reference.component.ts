...
export class PortsReferenceComponent {
  ...
  portsList: NetworkPort[] = [
    ...
    { number: 25, protocol: 'TCP', name: 'SMTP', category: 'Core', description: 'Simple Mail Transfer Protocol para envío de correos.', cvContext: 'Configurado con cifrado STARTTLS en servidores de notificaciones transaccionales (AWS SES).' },
    ...
    { number: 111, protocol: 'TCP/UDP', name: 'RPCBind', category: 'Core', description: 'Portmapper para mapeo de llamadas a procedimientos remotos (RPC).', cvContext: 'Común en montajes de almacenamiento de archivos compartidos NFS (AWS EFS).' },
    ...
    { number: 389, protocol: 'TCP/UDP', name: 'LDAP', category: 'Security/Admin', description: 'Lightweight Directory Access Protocol para autenticación en directorio activo.', cvContext: 'Integración de usuarios en AWS Directory Service / Active Directory.' },
    ...
    { number: 445, protocol: 'TCP', name: 'SMB over TCP', category: 'Core', description: 'Server Message Block para compartir archivos de Microsoft.', cvContext: 'Montaje de discos virtuales AD (AWS FSx) y vulnerado históricamente por EternalBlue.' },
    { number: 500, protocol: 'UDP', name: 'ISAKMP (VPN)', category: 'Core', description: 'Internet Security Association and Key Management Protocol para IPsec.', cvContext: 'Establecimiento de túneles VPN híbridos sitio a sitio entre AWS VPC y el datacenter físico.' },
    { number: 514, protocol: 'UDP', name: 'Syslog', category: 'Core', description: 'Envío de registros y logs del sistema a un colector.', cvContext: 'Centralización de auditoría de seguridad en herramientas SIEM (AWS CloudWatch Logs).' },
    ...
    { number: 636, protocol: 'TCP', name: 'LDAPS', category: 'Security/Admin', description: 'LDAP sobre SSL/TLS para autenticación segura en directorio.', cvContext: 'Autenticación cifrada obligatoria en regulaciones bancarias.' },
    ...
    { number: 1433, protocol: 'TCP', name: 'MS SQL Server', category: 'Database', description: 'Puerto estándar de conexión a Microsoft SQL Server Database Engine.', cvContext: 'Instancias empresariales en AWS RDS SQL Server.' },
    ...
    { number: 1521, protocol: 'TCP', name: 'Oracle DB', category: 'Database', description: 'Puerto de conexión por defecto del motor de base de datos relacional empresarial Oracle.', cvContext: 'Sistemas legacy de core bancario y procesamiento batch corporativo en AWS RDS.' },
    { number: 2049, protocol: 'TCP/UDP', name: 'NFS', category: 'Core', description: 'Network File System para almacenamiento compartido de archivos en red Linux.', cvContext: 'Utilizado directamente por el servicio AWS EFS (Elastic File System).' },
    ...
    { number: 3306, protocol: 'TCP', name: 'MySQL', category: 'Database', description: 'Motor de base de datos relacional de código abierto.', cvContext: 'Migración y soporte en AWS RDS MySQL / Aurora con réplicas de lectura.' },
    ...
    { number: 4500, protocol: 'UDP', name: 'IPsec NAT-T', category: 'Core', description: 'NAT Traversal para túneles VPN IPsec en redes protegidas.', cvContext: 'Conexiones seguras de clientes remotos corporativos hacia VPCs de AWS.' },
    ...
    { number: 5672, protocol: 'TCP', name: 'RabbitMQ AMQP', category: 'Core', description: 'Advanced Message Queuing Protocol para intermediario de mensajes (Broker).', cvContext: 'Desacoplamiento asíncrono de eventos y microservicios en banca transaccional (AWS Amazon MQ).' },
    ...
    { number: 6443, protocol: 'TCP', name: 'K8s API Server', category: 'Security/Admin', description: 'Kubernetes API Server Endpoint para administración de clústeres.', cvContext: 'Punto neurálgico de control en entornos AWS EKS / GCP GKE para orquestación de Pods.' },
    ...
    { number: 9092, protocol: 'TCP', name: 'Apache Kafka', category: 'Core', description: 'Puerto por defecto para agentes de transmisión de eventos distribuidos Kafka (Brokers).', cvContext: 'Ingesta masiva de telemetría de sensores IoT y procesamiento de Big Data en tiempo real (AWS MSK).' },
    { number: 9200, protocol: 'TCP', name: 'Elasticsearch', category: 'Database', description: 'Motor de búsqueda y analítica distribuida NoSQL RESTful.', cvContext: 'Centralización e indexación de logs de infraestructura en la pila ELK / OpenSearch en AWS.' },
    { number: 27017, protocol: 'TCP', name: 'MongoDB', category: 'Database', description: 'Puerto estándar del servidor de base de datos NoSQL orientada a documentos BSON.', cvContext: 'Almacenamiento flexible en AWS DocumentDB / MongoDB Atlas.' },
